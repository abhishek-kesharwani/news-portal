      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">View News Request</a>
          </div>
        </div>
      </li>
 <!-- Divider -->
      <hr class="sidebar-divider d-none d-md-block">
       ...
       <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Actions...</h6>
            <a class="collapse-item" href="reporterReg.jsp">Add Reporters</a>
            <a class="collapse-item" href="viewAllReporter.jsp">View All Reporters</a>
            <a class="collapse-item" href="pendingReporters.jsp">View Pending Reporters</a>
         </div>
        </div>
      </li>
      <!-- Divider -->
